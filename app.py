...
parser.add_argument('title', type=str, default='Add title')
parser.add_argument('due_date', type=str, default='Not due today')
...
class TodoList(Resource):
    ...
    def post(self):
        ...
        todo_list[todo_id] = {
            ...
            'completion_date': str(current_datetime),
            'creation_date': str(current_datetime),
            'last_updated': str(current_datetime)
        }
    ...
    def put(self, todo_id):
        ...
        if args['completed']:
            ...
            if args['completed'] is not True:
                todo_list[todo_id].update({'completion_date': 'Not Completed'})

        todo_list[todo_id].update({'last_updated': str(current_datetime)})
        return 201
